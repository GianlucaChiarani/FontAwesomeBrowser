...
(function () {
  window.fabrowser = function () {
    ...
    document.addEventListener("click", function (event) {
      ...
      if (!target.matches("input[data-fa-browser]")) return;

      if (!document.querySelector(".fa-browser-container")) {
        const iconContainer = document.createElement("div");
        iconContainer.className = "fa-browser-container";
